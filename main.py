                                                                                            ...
                                                                                            if first_name: body["first_name"] = first_name
                                                                                                if last_name: body["last_name"] = last_name
                                                                                                    if phone: body["phone"] = phone
                                                                                                        ...
                                                                                                        @mcp.tool()
                                                                                                        def flashy_update_contact(contact_id: str, email: str = "", first_name: str = "", last_name: str = "", phone: str = "") -> str:
                                                                                                                                ...
                                                                                                                                if phone: body["phone"] = phone
                                                                                                                                    ...
                                                                                                                                    def flashy_search_contacts(query: str, limit: int = 50) -> str:
                                                                                                                                        """Search contacts by email, name or phone"""
                                                                                                                                            return json.dumps(req("GET", "/contacts/search", params={"query": query, "limit": limit}))
                                                                                                                                            
                                                                                                                                            @mcp.tool()
                                                                                                                                            def flashy_list_lists() -> str:
                                                                                                                                                """Get all contact lists in Flashy"""
                                                                                                                                                                                        ...
                                                                                                                                                                                        """Get a specific message/campaign by ID"""
                                                                                                                                                                                            ...
                                                                                                                                                                                            def flashy_track_event(email: str, event_name: str) -> str:
                                                                                                                                                                                                """Track a custom event for a contact"""
                                                                                                                                                                                                    body = {"email": email, "event": event_name}
                                                                                                                                                                                                        return json.dumps(req("POST", "/events", body=body))
                                                                                                                                                                                                        
                                                                                                                                                                                                        @mcp.tool()
                                                                                                                                                                                                        def flashy_get_reports(limit: int = 20) -> str:
                                                                                                                                                                                                            """Get campaign reports and stats"""
